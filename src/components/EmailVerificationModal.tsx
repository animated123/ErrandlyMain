        ...
        {sent ? (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              >
                {verifying ? <Loader2 size={14} className="animate-spin" /> : "Verify Code"}
              </button>
          ...
          <div className="space-y-6">
            <div className="bg-indigo-50 p-6 rounded-2xl flex items-center gap-4">
              <div className="w-12 h-12 bg-card text-card-foreground rounded-xl flex items-center justify-center shadow-sm">
                <Mail className="text-indigo-600" size={14} />
              </div>
              <div>
                <p className="text-sm font-black text-indigo-400 tracking-normal font-medium">Email Address</p>
