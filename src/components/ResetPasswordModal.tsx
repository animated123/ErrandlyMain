      ...
      <div className="bg-card text-card-foreground w-full max-w-md rounded-[2.5rem] overflow-hidden shadow-2xl p-8 space-y-6">
        ...
        {step === 'email' && (
          <form onSubmit={handleSendCode} className="space-y-5">
            ...
            >
              {loading ? <Loader2 size={14} className="animate-spin" /> : "Send Reset Code"}
            </button>
          </form>
        )}
          ...
          <form onSubmit={handleVerifyCode} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <button 
                ...
                className="w-full py-3 text-muted-foreground hover:text-foreground text-sm font-black tracking-normal font-medium transition-colors"
              >
        ...
        {step === 'password' && (
          <form onSubmit={handleResetPassword} className="space-y-5">
            <div className="space-y-2">
              <label className="text-sm font-black text-muted-foreground tracking-normal font-medium ml-1">New Password</label>
              <div className="relative">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-foreground/70" size={14} />
                <input 
